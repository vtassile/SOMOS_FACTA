...
import { NgOptgroupTemplateDirective } from '@ng-select/ng-select/lib/ng-templates.directive';
...
export interface MenuChildrenItem {
  route: string;
  name: string;
  type: 'link' | 'sub' | 'extLink' | 'extTabLink'| 'muser';
